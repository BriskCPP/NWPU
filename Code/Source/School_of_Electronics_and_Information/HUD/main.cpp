			 ...
			 )
{
	...
	std::list<LineList> testLineListList;
	...
	LineList temp = LineList(window, testVertexPairVector);
	...
	LineList temp1 = LineList(window, testVertexPairVector, Vector(-500, 500),Vector(0,0,0.003*totalTime));
	testVertexPairVector.clear();
	...
	LineList temp2 = LineList(window, testVertexPairVector, Vector(500, 500), Vector(0, 0, 0.003*totalTime));
	testVertexPairVector.clear();
	...
	LineList temp3 = LineList(window, testVertexPairVector, Vector(-500, -500), Vector(0, 0, 0.003*totalTime));
	testVertexPairVector.clear();
	...
	LineList temp4 = LineList(window, testVertexPairVector, Vector(500, -500), Vector(0, 0, 0.003*totalTime));
	testVertexPairVector.clear();

	testComposite.add(&temp);
	testComposite.add(&temp1);
	testComposite.add(&temp2);
	testComposite.add(&temp3);
	testComposite.add(&temp4);
